...
if 'roc' in do_analyses:
	...
	for SIG_sample, mass_center in zip(SIG_samples, mass_centers):
		...
		for loss_ids, loss_name in zip([strategy_ids_kl_loss, strategy_ids_reco_loss, strategy_ids_reco_kl_loss, strategy_ids_total_loss, strategy_ids_recopT_loss], ['KL_loss', 'reco_loss', 'reco_kl_loss', 'total_loss', 'recopT_loss']):
			# plot full ROC
			print(loss_ids)
			print(loss_name)
