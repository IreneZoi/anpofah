...
def analyze_constituents_bg_vs_sig(event_sample_dict, sample_names=None, bg_name=None, string_suffix=None, fig_dir='fig', fig_format='.pdf'):
    ...
    bg_name = bg_name or [s in event_sample_dict.keys() if 'qcd' in s][0] # find first sample called 'qcd' if bg_name not given
    ...
    plot_name = '_'.join(filter(None, ['constituents', 'jet1', string_suffix]))
    pu.plot_m_features_for_n_samples(data=p1, feature_names=p_feature_names, sample_names=sample_names, single_row=True, plot_name=plot_name, fig_dir=fig_dir, fig_format='.png', fig_size=(12,6), bg_name=bg_name)
    plot_name = '_'.join(filter(None, ['constituents', 'jet2', string_suffix]))
    pu.plot_m_features_for_n_samples(data=p2, feature_names=p_feature_names, sample_names=sample_names, single_row=True, plot_name=plot_name, fig_dir=fig_dir, fig_format='.png', fig_size=(12,6), bg_name=bg_name)
