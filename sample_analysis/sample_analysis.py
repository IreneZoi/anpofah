...
def plot_feature(sample_dict, feature_name, sample_names=None, plot_name='plot', fig_dir=None, first_is_bg=True, clip_outlier=False, map_fun=None):
	if not sample_names: 
	...
	if first_is_bg:
		pu.plot_bg_vs_sig(feature, legend=legend, xlabel=feature_name, title=r'distribution '+feature_name,legend_loc=(1.05,0), plot_name=plot_name, fig_dir=fig_dir, clip_outlier=clip_outlier)
	else:
