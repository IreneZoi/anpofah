...
if 'roc' in do_analyses:
	...
	for SIG_sample in SIG_samples + [BG_SR_sample]:
		ra.plot_ROC_loss_strategy(data[BG_sample], data[SIG_sample], strategy_ids_total_loss, plot_name_suffix='_total_loss_', fig_dir=experiment.model_analysis_dir_roc) 
...
# *****************************************
	...
	fea.plot_feature(data, 'j1KlLoss', sample_names=[BG_sample]+SIG_samples, plot_name='loss_distr_KL1_qcdSB_vs_sig', fig_dir=experiment.model_analysis_dir_loss)
	fea.plot_feature(data, 'j2KlLoss', sample_names=[BG_sample]+SIG_samples, plot_name='loss_distr_KL2_qcdSB_vs_sig', fig_dir=experiment.model_analysis_dir_loss)
	...
	fea.plot_feature(data, 'j1KlLoss', sample_names=[BG_SR_sample]+SIG_samples, plot_name='loss_distr_KL1_qcdSR_vs_sig', fig_dir=experiment.model_analysis_dir_loss)
	fea.plot_feature(data, 'j2KlLoss', sample_names=[BG_SR_sample]+SIG_samples, plot_name='loss_distr_KL2_qcdSR_vs_sig', fig_dir=experiment.model_analysis_dir_loss)
	...
	fea.plot_feature(data, 'j1KlLoss', sample_names=[BG_sample, BG_SR_sample], plot_name='loss_distr_KL1_qcdSB_vs_qcdSR', fig_dir=experiment.model_analysis_dir_loss)
	fea.plot_feature(data, 'j2KlLoss', sample_names=[BG_sample, BG_SR_sample], plot_name='loss_distr_KL2_qcdSB_vs_qcdSR', fig_dir=experiment.model_analysis_dir_loss)
